...
로컬에서 직접 탐색한다. 읽기 순서는 repo guidance/README, `docs/context/current-state.md`,
`docs/04_IMPLEMENTATION_PLAN.md`, thin current docs, 작업 관련 source/tests 순서다.
...
**## NEXT TASK**
milestone / track / phase / slice, 파일/영역, gate/acceptance criteria, docs update,
validation을 포함한 하나의 작업.
