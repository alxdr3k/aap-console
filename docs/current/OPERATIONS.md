...
- Release source: `dev` is the integration branch; production promotion to
  `main` remains outside this migration.
- Deployment owner: not fully accepted; production deploy and rollback evidence
  remain tracked by `OPS-7A.1` / `AC-019`.
