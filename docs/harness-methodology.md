...
- 전체 아키텍처는 **짧은 개요 + 파일 포인터** 로 제공 (예: `@docs/02_HLD.md`)
...
- [HLD](./02_HLD.md) — High-Level Design
- [ADR 001~006](./adr/adr-001-provisioning-orchestration.md) — 아키텍처 의사결정
