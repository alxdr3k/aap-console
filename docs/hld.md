...
### 10.1 프로비저닝 병렬 단계: Thread vs 별도 Job
...
### 10.2 RBAC: DB 테이블 vs Keycloak SSOT
...
### 10.3 설정 스냅샷: Config Server 조회 vs Console DB 저장
