...
Accepted: PAK issue/revoke/verify API is implemented. SAML/OAuth backend provisioning is covered by Keycloak client and step specs. UI/metadata screens are non-gating follow-up per `DEC-003`.

**Decision / Next Step**

- Decision: `DEC-003`
- Follow-up: UI work when auth UI resumes
