...
| `TEST-014` | Core product UI system/request specs | partial request/model specs cover layout, Organization index empty states, super_admin create affordance, and authz scope; broader organization detail, project pages, member UI, role-aware controls, and form errors remain planned | `AC-014` |
