...
| `TEST-014` | Core product UI system/request specs | partial request/model specs cover layout, Organization index/detail/new/edit pages, member management pages, role-aware empty states/actions, HTML form errors, 404 shells, and authz scope; project pages remain planned | `AC-014` |
