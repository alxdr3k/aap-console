...
### 10.4 Langfuse API: tRPC vs Admin API vs DB 직접 조작
...
### 10.5 외부 API 연동: Terraform Provider vs 직접 호출
...
### 10.6 설정 스냅샷: Config Server 조회 vs Console DB 저장
