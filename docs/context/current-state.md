...
- active slices: `CORE-5A.1`, `CORE-5A.2`, `CORE-5A.3`, `UI-5A.1`, and `UI-5A.2` landed; next candidates are `UI-5A.3`, `UI-5A.4`, `UI-5B.1`
...
1. `UI-5A.3`~`UI-5A.4`로 member management와 Project pages를 구현한다.
